...
import { setnewpassLang } from './Setnewpass.lang';
import background from 'assets/images/login-background.jpg';
import { Link } from 'react-router-dom';
import { get, post, responseValidator } from 'scripts/api';
import { APIPath, RoutePath } from 'data';

class Setnewpass extends React.Component<any, any> {
                ...
                <div className="box">
                    ...
                    <div className="blackbox">
                        <div className="context">
                            ...
                            <div className="responsesetnewpassSuccess" hidden={this.state.hideSuccess}>
                                <i className="material-icons">check_circle_outline</i>
                                <h2>{setnewpassLang.body.successful}</h2>
                                <div className="gotodiv">
                                    <p>{setnewpassLang.body.goto}</p>
                                    <Link className="linktag" to={RoutePath.login}>
                                        {setnewpassLang.body.login}
                                    </Link>
                                </div>
                            </div>
                            <div className="responsesetnewpassFail" hidden={this.state.hidefail}>
                                <i className="material-icons">highlight_off</i>
                                <h2>{setnewpassLang.body.error}</h2>
                                <div className="gotodiv">
                                    <p>{setnewpassLang.body.goto}</p>
                                    <Link className="linktag" to={RoutePath.login}>
                                        {setnewpassLang.body.login}
